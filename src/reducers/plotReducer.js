...
const defaultState = {
    ...
    sampleSelection: [
        {sampleName: '8967', selected: true, description: 'U2OS 4 uM'},
        {sampleName: '9052', selected: true, description: 'U2OS 4 uM'},
        {sampleName: '9053', selected: true, description: 'U2OS 4 uM'},
        {sampleName: '8968', selected: true, description: 'U2OS 32 uM'},
        {sampleName: '9508', selected: true, description: 'U2OS 32 uM'},
        {sampleName: '10590', selected: true, description: 'U2OS KO 32 uM'},
        {sampleName: '9062', selected: true, description: 'HCT116 2 uM'},
        {sampleName: '9063', selected: true, description: 'HCT116 2 uM'},
        {sampleName: '9064', selected: true, description: 'HCT116 2 uM'},
        {sampleName: '8987', selected: true, description: 'HCT116 32 uM'},
        {sampleName: '9507', selected: true, description: 'HCT116 32 uM'},
        {sampleName: '11116', selected: true, description: 'HCT116 32 uM'},
        {sampleName: '10591', selected: true, description: 'HCT116 DKO 32 uM'},
        {sampleName: '10643', selected: true, description: 'HCT116 DKO 32 uM'},
        {sampleName: '10960', selected: true, description: 'HCT116 DKO 2 uM'},
        {sampleName: '10961', selected: true, description: 'HCT116 DKO 2 uM'},
        {sampleName: '10962', selected: true, description: 'HCT116 DKO 2 uM'},
    ],
    protein: null,
